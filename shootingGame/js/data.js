...
//文字通りスプライトという名の教室(クラスルーム)を作る.
class Sprite
{
	/*コンストラクターはそれぞれの生徒が持つ性質の紹介。
	  this.?は各生徒が共通して持つ要素のこと。
	  ()内の変数は各生徒ごとで違い得る要素の存在を示す。
	  つまり、スプライトというクラスではみんながthis.?という要素を
	  持っているがその要素の内容は各生徒ごとで変わり得るということ。
	 */
